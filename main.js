    ...
    $('.amountvalue').click(function(){
        ...
        obj[txt] = parseInt(prompt("enter quantity for "+txt + " notes"))
        console.log(obj);
        //document.getElementById("php_fivethousand").innerHTML=php5000;
